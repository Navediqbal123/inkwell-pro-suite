...
import { LogIn, LogOut, User, Shield, ChevronDown, History, Activity } from 'lucide-react';
          ...
          >
            ...
            <div className="px-3.5 py-4 mb-2 rounded-xl bg-gradient-to-br from-secondary/60 to-secondary/30 border border-border/20">
              <div className="flex items-center gap-3.5">
                ...
                <div 
                  className={`
                    relative w-12 h-12 rounded-full flex items-center justify-center text-base font-bold overflow-hidden
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div 
                    className={`
                      ...
                      ${isAdmin 
                        ? 'bg-gradient-to-r from-amber-500/15 to-purple-500/15 text-amber-400/90 border border-amber-500/25' 
            ...
            <div className="space-y-0.5">
              ...
              >
                <div className="p-2 rounded-lg bg-accent/8 group-hover:bg-accent/15 transition-colors duration-200">
                  <User className="w-4 h-4 text-accent/80 group-hover:text-accent" />
                </div>
              ...
              >
                <div className="p-2 rounded-lg bg-primary/8 group-hover:bg-primary/15 transition-colors duration-200">
                  <Activity className="w-4 h-4 text-primary/80 group-hover:text-primary" />
                </div>
